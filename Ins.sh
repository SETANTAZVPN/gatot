...
MYIP=$(wget -qO- ipinfo.io/ip);
IZIN=$(curl -sS https://raw.githubusercontent.com/SETANTAZVPN/gatot/main/Name | grep $MYIP | awk '{print $1}')
valid=$(curl -sS https://raw.githubusercontent.com/SETANTAZVPN/gatot/main/Name | grep $MYIP | awk '{print $4}')
Name=$(curl -sS https://raw.githubusercontent.com/SETANTAZVPN/gatot/main/Name | grep $MYIP | awk '{print $3}')
Versi=$(curl -sS https://raw.githubusercontent.com/SETANTAZVPN/gatot/main/Name | grep $MYIP | awk '{print $5}')
echo "Loading..."
sleep 2
if [ $MYIP = $IZIN ]; then
